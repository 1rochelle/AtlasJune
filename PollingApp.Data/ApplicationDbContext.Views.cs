...
[assembly: DbMappingViewCacheTypeAttribute(
    typeof(PollingApp.Data.ApplicationDbContext),
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets5e6017b56eca4196cd597a5ff3dbb83f2c8c639b02392de9b38afe161c741813))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySets5e6017b56eca4196cd597a5ff3dbb83f2c8c639b02392de9b38afe161c741813 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "5e6017b56eca4196cd597a5ff3dbb83f2c8c639b02392de9b38afe161c741813"; }
        }
    ...
    SELECT VALUE -- Constructing Roles
        [PollingApp.Data.IdentityRole](T1.IdentityRole_Id, T1.IdentityRole_Name)
    FROM (
        SELECT 
            T.Id AS IdentityRole_Id, 
            T.Name AS IdentityRole_Name, 
    ...
    SELECT VALUE -- Constructing IdentityUserRoles
        [PollingApp.Data.IdentityUserRole](T1.IdentityUserRole_UserId, T1.IdentityUserRole_RoleId)
    FROM (
        SELECT 
            T.UserId AS IdentityUserRole_UserId, 
            T.RoleId AS IdentityUserRole_RoleId, 
    ...
    SELECT VALUE -- Constructing Users
        [PollingApp.Data.ApplicationUser](T1.ApplicationUser_Id, T1.ApplicationUser_Email, T1.ApplicationUser_EmailConfirmed, T1.ApplicationUser_PasswordHash, T1.ApplicationUser_SecurityStamp, T1.ApplicationUser_PhoneNumber, T1.ApplicationUser_PhoneNumberConfirmed, T1.ApplicationUser_TwoFactorEnabled, T1.ApplicationUser_LockoutEndDateUtc, T1.ApplicationUser_LockoutEnabled, T1.ApplicationUser_AccessFailedCount, T1.ApplicationUser_UserName)
    FROM (
        SELECT 
            T.Id AS ApplicationUser_Id, 
            T.Email AS ApplicationUser_Email, 
    ...
    SELECT VALUE -- Constructing IdentityUserClaims
        [PollingApp.Data.IdentityUserClaim](T1.IdentityUserClaim_Id, T1.IdentityUserClaim_UserId, T1.IdentityUserClaim_ClaimType, T1.IdentityUserClaim_ClaimValue)
    FROM (
        SELECT 
            T.Id AS IdentityUserClaim_Id, 
            T.UserId AS IdentityUserClaim_UserId, 
    ...
    SELECT VALUE -- Constructing IdentityUserLogins
        [PollingApp.Data.IdentityUserLogin](T1.IdentityUserLogin_LoginProvider, T1.IdentityUserLogin_ProviderKey, T1.IdentityUserLogin_UserId)
    FROM (
        SELECT 
            T.LoginProvider AS IdentityUserLogin_LoginProvider, 
            T.ProviderKey AS IdentityUserLogin_ProviderKey, 
